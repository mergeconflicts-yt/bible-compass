...
| PD-018 | Sign-in methods        | OPEN     | Defer until Phase 9; start with the minimum approved method                                              | Select before sync implementation                                                         |
| PD-019 | Analytics              | OPEN     | Explicit first-party event gateway plus crash reporting                                                  | Approve provider, region and retention                                                    |
| PD-020 | Notification behavior  | PARTIAL  | Optional daily reminder at user-selected local time                                                      | Approve default copy and scheduling policy                                                |
