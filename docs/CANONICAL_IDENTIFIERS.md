...
- **Presentation vs. storage.** Public URL ` /passage/Neh.2.1-Neh.2.8` is a _presentation_ identifier. The qualified envelope `{"refsys":"refsys:eng-v22","local":"Neh.2.1-Neh.2.8"}` is the _storage_ identity.
