...
TVTMS = "release:source:stepbible:tvtms@ae39711d:sha-63058e0f"
...
_LOCAL = [
    ...
    ("tvtms", TVTMS, "source:stepbible:tvtms", [
        ("neh-2", "Neh.2 mapping", "Nehemiah 2 versification mapping record"),
    ]),
]
...
ENTITIES = [
    ...
    ent("god-of-heaven", "person", "The God of heaven", [], "established",
        ...
        ["nehemiah-prays", "god-grants-success"]),
    ...
    ent("jerusalem-wall", "structure", "The wall of Jerusalem", ["the city wall"], "established",
        "The broken wall and burned gates that Nehemiah inspects and rebuilds.",
        "Jerusalem's wall and gates had been broken down and destroyed by fire (2:3, 13, 17). Nehemiah inspects the damage by night and calls the people to rebuild the wall.",
        ["wall-destroyed-by-fire", "jerusalem-wall-part-of-jerusalem", "nehemiah-inspects-wall", "people-agree-rebuild"]),
...
CLAIMS = [
    ...
    claim("wall-destroyed-by-fire", ("entity", "jerusalem-wall"), "destroyed_by_fire",
          ("text", "the wall and gates of Jerusalem"),
    ...
    claim("people-agree-rebuild", ("entity", "judean-people"), "rebuilds", ("entity", "jerusalem-wall"),
          ["bsb:neh-2-17", "bsb:neh-2-18"], "explicit"),
    claim("god-grants-success", ("entity", "god-of-heaven"), "grants_success", ("scope", S_ANSWER),
          ["bsb:neh-2-20"], "explicit"),
    claim("opponents-no-claim", ("entity", "sanballat-the-horonite"), "has_no_claim_in", ("entity", "jerusalem"),
          ["bsb:neh-2-20"], "explicit"),
    ...
    claim("prior-stop-order", ("scope", S_REQUEST), "preceded_by",
          ("text", "an imperial order that stopped the city's rebuilding by force"),
          ["bsb:ezra-4-17"], "explicit", "probable"),
...
ATTEST: dict[int, list[tuple[str, str, str, str]]] = {
    1: [("nehemiah-governor", "primary_subject", "established", "explicit"),
    ...
    2: [("artaxerxes-i", "participant", "established", "explicit"),
        ("nehemiah-governor", "participant", "established", "explicit")],
    3: [("nehemiah-governor", "participant", "established", "explicit"),
        ("artaxerxes-i", "participant", "established", "explicit"),
    ...
    5: [("nehemiah-governor", "participant", "established", "explicit"),
        ("artaxerxes-i", "participant", "established", "explicit"),
    ...
    6: [("artaxerxes-i", "participant", "established", "explicit"),
        ...
        ("nehemiah-governor", "participant", "established", "explicit")],
    7: [("nehemiah-governor", "participant", "established", "explicit"),
        ("artaxerxes-i", "participant", "established", "explicit"),
        ...
        ("judah", "location", "established", "explicit")],
    8: [("artaxerxes-i", "participant", "established", "explicit"),
    ...
    9: [("nehemiah-governor", "participant", "established", "explicit"),
        ("governors-beyond-the-river", "participant", "established", "explicit"),
        ("beyond-the-river", "location", "established", "explicit"),
        ("royal-letters", "topic", "established", "explicit"),
        ("royal-escort", "participant", "established", "explicit"),
        ("artaxerxes-i", "implied_referent", "established", "strongly_implied")],
    10: [("sanballat-the-horonite", "participant", "established", "explicit"),
         ("tobiah-ammonite", "participant", "established", "explicit"),
         ("israelites", "participant", "established", "explicit")],
    11: [("nehemiah-governor", "participant", "established", "explicit"),
         ("jerusalem", "location", "established", "explicit")],
    12: [("nehemiah-governor", "participant", "established", "explicit"),
         ("jerusalem", "location", "established", "explicit"),
         ("god-of-heaven", "topic", "established", "explicit")],
    13: [("nehemiah-governor", "participant", "established", "explicit"),
         ...
         ("jerusalem-wall", "topic", "established", "explicit"),
         ("jerusalem", "location", "established", "explicit")],
    14: [("nehemiah-governor", "participant", "established", "explicit"),
         ("fountain-gate", "location", "established", "explicit"),
         ("kings-pool", "location", "established", "explicit"),
         ("jerusalem-wall", "topic", "established", "strongly_implied")],
    15: [("nehemiah-governor", "participant", "established", "explicit"),
         ("jerusalem-wall", "topic", "established", "explicit"),
         ("valley-gate", "location", "established", "explicit")],
    16: [("nehemiah-governor", "participant", "established", "explicit"),
         ("judean-people", "participant", "established", "explicit")],
    17: [("nehemiah-governor", "participant", "established", "explicit"),
         ("jerusalem-wall", "topic", "established", "explicit"),
         ("jerusalem", "location", "established", "explicit"),
         ("judean-people", "participant", "established", "inferred")],
    18: [("nehemiah-governor", "participant", "established", "explicit"),
         ("judean-people", "participant", "established", "explicit"),
         ("artaxerxes-i", "implied_referent", "established", "strongly_implied")],
    19: [("sanballat-the-horonite", "participant", "established", "explicit"),
         ...
         ("nehemiah-governor", "participant", "established", "explicit"),
         ("artaxerxes-i", "implied_referent", "established", "strongly_implied")],
    20: [("nehemiah-governor", "participant", "established", "explicit"),
         ("god-of-heaven", "topic", "established", "explicit"),
         ("judean-people", "participant", "established", "explicit"),
         ("jerusalem", "location", "established", "explicit"),
...
EVENTS = [
    ...
    },
    {
        ...
        "claims": ["opponents-no-claim", "god-grants-success"],
    },
]
...
RELEVANCE = [
    ...
    (S_REQUEST, "cupbearer", "supporting", False, ["nehemiah-cupbearer"]),
    (S_REQUEST, "queen", "background", True, ["queen-present"]),
    (S_REQUEST, "jerusalem", "central", False, ["jerusalem-ancestral-city"]),
    ...
    (S_REQUEST, "kings-forest", "background", False, ["asaph-keeper-forest"]),
    ...
    (S_INSPECTION, "jerusalem-wall", "central", True, ["nehemiah-inspects-wall", "wall-destroyed-by-fire"]),
    ...
    (S_INSPECTION, "judean-people", "background", False, []),
    # rally 2.17-18
    ...
    (S_RALLY, "artaxerxes-i", "background", False, ["artaxerxes-grants-request"]),
    # answer 2.19-20
    (S_ANSWER, "nehemiah-governor", "central", True, ["god-grants-success"]),
    (S_ANSWER, "sanballat-the-horonite", "supporting", True, ["opponents-no-claim"]),
    (S_ANSWER, "tobiah-ammonite", "supporting", True, ["tobiah-opposes"]),
    (S_ANSWER, "geshem-arabian", "supporting", True, ["geshem-opposes"]),
    (S_ANSWER, "artaxerxes-i", "background", False, []),
    (S_ANSWER, "god-of-heaven", "central", True, ["god-grants-success"]),
    (S_ANSWER, "jerusalem", "supporting", True, ["opponents-no-claim"]),
...
ROLE_TEXT = {
    ...
    (S_INSPECTION, "jerusalem-wall"): "The broken wall and burned gates are the object of Nehemiah's inspection.",
...
CONTEXTS = {
    ...
    S_INSPECTION: {
        ...
        "what": ("Nehemiah secretly inspects the broken walls and burned gates, finding the damage so extensive that at the King's Pool his mount cannot pass through.", ["nehemiah-inspects-wall", "wall-destroyed-by-fire"], None),
    ...
    S_RALLY: {
        ...
        "what": ("Nehemiah tells the people of the city's ruin and disgrace, of the gracious hand of God and of the king's words, and they agree to start rebuilding.", ["people-agree-rebuild", "wall-destroyed-by-fire"], None),
    ...
    S_ANSWER: {
        ...
        "where": ("Jerusalem.", ["opponents-no-claim"], None),
        "when": ("After the people commit to rebuild.", [], None),
        "what": ("The opponents mock the builders and accuse them of rebelling against the king. Nehemiah answers that the God of heaven will grant success, and that they have no portion, right or claim in Jerusalem.", ["opponents-no-claim", "god-grants-success"], None),
        ...
        "immediate_summary": ("Nehemiah answers the opponents' mockery with confidence in God.", ["god-grants-success"], None),
    },
}
...
MENTIONS: dict[int, list[tuple[str, str, str, int]]] = {
    1: [("artaxerxes-i", "King Artaxerxes", "explicit_name", 1),
        ("wine", "wine", "explicit_name", 1)],
    2: [("artaxerxes-i", "the king", "title", 1)],
    3: [("artaxerxes-i", "the king", "title", 1),
        ("jerusalem", "the city where my fathers are buried", "indirect", 1)],
    4: [("artaxerxes-i", "the king", "title", 1),
        ("god-of-heaven", "the God of heaven", "explicit_name", 1),
        ("prayer-to-god-of-heaven", "prayed", "indirect", 1)],
    5: [("artaxerxes-i", "the king", "title", 1),
        ("judah", "Judah", "explicit_name", 1),
        ("jerusalem", "the city where my fathers are buried", "indirect", 1)],
    6: [("artaxerxes-i", "the king", "title", 1),
        ("queen", "the queen", "title", 1)],
    7: [("artaxerxes-i", "the king", "title", 1),
        ...
        ("judah", "Judah", "explicit_name", 1)],
    8: [("asaph-royal-park", "Asaph", "explicit_name", 1),
    ...
    9: [("governors-beyond-the-river", "the governors west of the Euphrates", "collective", 1),
        ("royal-letters", "the king\u2019s letters", "indirect", 1),
        ("royal-escort", "army officers and cavalry", "collective", 1)],
    10: [("sanballat-the-horonite", "Sanballat the Horonite", "explicit_name", 1),
         ("tobiah-ammonite", "Tobiah the Ammonite official", "explicit_name", 1),
         ("israelites", "the Israelites", "collective", 1)],
    11: [("jerusalem", "Jerusalem", "explicit_name", 1)],
    12: [("jerusalem", "Jerusalem", "explicit_name", 1),
         ("god-of-heaven", "my God", "indirect", 1)],
    13: [("valley-gate", "the Valley Gate", "explicit_name", 1),
    ...
    14: [("fountain-gate", "the Fountain Gate", "explicit_name", 1),
         ("kings-pool", "the King\u2019s Pool", "explicit_name", 1)],
    15: [("jerusalem-wall", "the wall", "indirect", 1),
         ("valley-gate", "the Valley Gate", "explicit_name", 1)],
    16: [("judean-people", "the Jews", "collective", 1)],
    17: [("jerusalem-wall", "the wall of Jerusalem", "indirect", 1),
         ("jerusalem", "Jerusalem", "explicit_name", 2),
         ("judean-people", "us", "pronoun", 1)],
    18: [("judean-people", "they", "pronoun", 1)],
    19: [("sanballat-the-horonite", "Sanballat the Horonite", "explicit_name", 1),
         ("tobiah-ammonite", "Tobiah the Ammonite official", "explicit_name", 1),
         ("geshem-arabian", "Geshem the Arab", "explicit_name", 1),
         ("artaxerxes-i", "the king", "title", 1)],
    20: [("god-of-heaven", "The God of heaven", "explicit_name", 1),
...
def mention_key(vs: int, slug: str) -> str:
    return f"mention:bsb-neh-2-{vs}:{slug}"
